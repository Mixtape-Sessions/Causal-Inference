...
* description: simple program going through the lady tasting tea example
...
* save the original dataset into memory
tempfile correct
...
* The probability that Muriel Bristol guessed correctly the ordering of the 
* original treatment assignment out of every possible treatment assignment. 
su pvalue
